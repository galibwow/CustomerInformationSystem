...
namespace CustomerInformationSystem.Controllers
{
    public class DesignationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DesigId,DesigName")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DesigId,DesigName")] Designation designation)
        {
            if (ModelState.IsValid)
            {
